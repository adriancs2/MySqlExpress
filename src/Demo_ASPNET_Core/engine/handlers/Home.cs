...
<div class='card'>
    ...
    <p class='muted mb-2'>
        ...
        you would use <code>appsettings.json</code>, environment variables, or a secrets manager.
    </p>
    <div class='form-row'>
...
function testConn() {
    ...
    fetch('/api/setup/test-conn', { method: 'POST', body: formData })
...
function saveConn() {
    ...
    fetch('/api/setup/save-conn', { method: 'POST', body: formData })
        .then(function(r) { return r.json(); })
        .then(function(d) {
