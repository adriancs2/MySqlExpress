...
<div class='card'>
    ...
    <p class='muted mb-2'>
        ...
        <code>/App_Data/mysql_conn.txt</code> next to the EXE. This is a demo;
        in production, you would use environment variables or a secrets manager.
    </p>
    <div class='form-row'>
...
<div class='card'>
    ...
    <p class='muted'>
        Architecturally, the entire request pipeline runs in this single
        console process: a <code>TcpListener</code> on the socket, the cshttp
        parser turning bytes into a structured request, a switch statement
        dispatching to handlers, and <code>HttpResponse</code> from cshttp
        turning the result back into bytes. No IIS. No Kestrel.
    </p>
</div>
");
            sb.Append(@"
...
");
        ...
        static void AppendDashboard(StringBuilder sb)
        {
            ...
            // Attempt to automatically create database
